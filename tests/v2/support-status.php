...
namespace {
    ...
    statusCheck(
        substr_count($handlerSource, '$this->requirePost();') === 9,
        'status/identity/actions/submissionVerify/submissions/submissionSupport/requiredActions/publicationStatus/paymentStatus must all be POST-only'
    );
