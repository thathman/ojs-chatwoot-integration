...
namespace {
    ...
    statusCheck(
        substr_count($handlerSource, '$this->requirePost();') === 11,
        'status/identity/actions/accountDiagnostics/submissionDiagnostics/submissionVerify/submissions/submissionSupport/requiredActions/publicationStatus/paymentStatus must all be POST-only'
    );
